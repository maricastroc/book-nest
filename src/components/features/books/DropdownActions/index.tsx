  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-full border-0 bg-white/[0.06] text-fg3 transition-colors hover:bg-white/[0.12] hover:text-fg focus:outline-none"
      >
      ...
      {isDropdownOpen && (
        <div
          ref={dropdownRef}
          className="absolute right-0 top-[calc(100%+8px)] z-[9997] min-w-[184px] overflow-hidden rounded-xl border border-line bg-el p-1.5 shadow-[0_16px_36px_rgba(0,0,0,0.55)]"
        >
          <button
            onClick={handleEditClick}
            className="flex w-full cursor-pointer items-center gap-2.5 whitespace-nowrap rounded-lg border-0 bg-transparent px-3 py-2 text-left text-[0.85rem] font-medium text-fg2 transition-colors hover:bg-white/[0.06] hover:text-fg"
          >
            <FontAwesomeIcon
              icon={faPenToSquare}
