...
export function RatingCard({ rating, onOpenDetails }: RatingCardProps) {
  ...
  return (
    <div className="bn-scope w-full rounded-[12px] border border-line bg-s1 p-4 transition-colors hover:border-line-strong sm:p-5">
      {/* Header: avatar + name + activity + stars */}
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-start gap-4">
            <img
              ...
              className="w-[88px] shrink-0 cursor-pointer rounded-[8px] shadow-[0_6px_16px_rgba(0,0,0,0.5)] transition-[filter] hover:brightness-110 sm:w-[96px]"
            />
